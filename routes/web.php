...
Route::get('/admin/product', [App\Http\Controllers\HomeUser::class, 'addProduct'])->name('addProduct')->middleware('auth');
Route::get('/admin/solde', [App\Http\Controllers\HomeUser::class, 'solde'])->name('solde')->middleware('auth');
